...
def main(
    ...
    print(
        "PHAROS-COMBO MORGAN + CLAMP HYBRID"
    )
    ...
    print(
        "Drug fusion: "
        "learned feature-wise Morgan/CLAMP gate"
    )
    ...
    for epoch in range(
        ...
        if (
            ...
            best_metrics[
                ...
                "morgan_pretrained_clamp_hybrid"
            )
