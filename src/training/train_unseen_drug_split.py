...
def make_unseen_drug_split(dataset, val_frac=0.2, seed=42):
    metadata = dataset.get_metadata()

    unique_drugs = metadata["broad_id"].dropna().unique()
    ...
    train_indices = metadata.index[metadata["broad_id"].isin(train_drugs)].tolist()
    val_indices = metadata.index[metadata["broad_id"].isin(val_drugs)].tolist()
...
def run_experiment(model_name, model, train_loader, val_loader, device, epochs=10, patience=3):
    print("\n==============================")
    print(f"Running unseen-drug experiment: {model_name}")
    print("==============================")
...
def main():
    ...
    train_indices, val_indices = make_unseen_drug_split(
        dataset,
        val_frac=0.2,
        seed=42,
    )
    ...
    print("\n==============================")
    print("Final unseen-drug split results")
    print("==============================")
    print(results_df)
    ...
    output_path = output_dir / "unseen_drug_results.csv"
