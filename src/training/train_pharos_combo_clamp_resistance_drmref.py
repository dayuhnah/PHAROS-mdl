...
class HybridComboDRMrefDataset(Dataset):
    """
    Add cached frozen CLAMP embeddings to the PHAROS-Combo DRMref
    dataset.

    Base dataset already supplies:
      - Morgan fingerprints
      - general cell expression
      - 29-gene core resistance expression
      - DRMref signed resistance expression for Drug A / Drug B
      - DRMref availability flags
      - ZIP label
    """
    ...
    def __getitem__(
        ...
        if missing:
            raise KeyError(
                "Base dataset missing DRMref V3 fields: "
                + ", ".join(
                    missing
                )
            )
...
def evaluate(
    ...
    if evidence_mask.any():
        ...
        metrics[
            "mean_drmref_norm_when_available"
        ] = (
            drmref_norm[
                evidence_mask
            ]
...
def main(
    ...
    print(
        "PHAROS-COMBO DRMref RESISTANCE V3"
    )
    print(
        "======================================"
    )
    ...
    print(
        "DRMref resistant-cell residual branch: ON"
    )

    print(
        "DRMref integration: "
        "availability-gated residual"
    )
    ...
    print(
        "STARTING DRMref RESISTANCE V3 TRAINING"
    )
    print(
        "======================================\n"
    )
    ...
    for epoch in range(
        ...
        print(
            ...
            f"DRM-alpha: "
            f"{metrics['mean_drmref_alpha_when_available']:.3f} | "
            f"LR: {current_lr:.2e}"
        )
        ...
        if (
            ...
            best_metrics[
                ...
                "DRMref_6481_gene_signed_"
                "resistant_vs_sensitive_cell_signature"
            )
    ...
    print(
        "DRMref RESISTANCE V3 TRAINING COMPLETE"
    )
    print(
        "======================================"
    )
